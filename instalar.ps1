...
function New-DesktopShortcut {
    ...
    $shortcut.Save()
    Write-Step "Acceso directo creado en el escritorio (actualización automática)"
}
...
if (-not $SinAbrir) {
    ...
    & "$PSScriptRoot\actualizar.ps1" -SinAbrir
}
...
Write-Host "Actualizar:     .\actualizar.ps1" -ForegroundColor White
